...
#+END_SRC
**** Extensions
#+BEGIN_SRC sh :tangle scripts/.local/bin/functions/firefox/extensions :shebang "#!/usr/bin/env bash"
  extInstall() {
      ...
      setsid --fork firefox --profile "${FIREFOX_REMOTE_PATH}/${1}" --new-tab "${FIREFOX_EXTENSIONS[@]}" 2>/dev/null 1>&2
  }
#+END_SRC
*** Plasma

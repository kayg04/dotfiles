...
* Awesome
** rc.lua
#+BEGIN_SRC lua :tangle awesomewm/.config/awesome/rc.lua
...
** Themes
*** Default
#+BEGIN_SRC lua :tangle awesomewm/.config/awesome/themes/default/theme.lua
  ---------------------------
...
#+END_SRC
* Compton
#+BEGIN_SRC conf :tangle compton/.config/compton/compton.conf
  # Shadow
  shadow = true;
  no-dnd-shadow = true;
  no-dock-shadow = true;
...
* Desktop
** Deezer
#+BEGIN_SRC conf :tangle desktop/.local/share/applications/deezer.desktop
  [Desktop Entry]
  Name=Deezer
  StartupNotify=true
  Icon=deezer
...
#+END_SRC
** Riot
#+BEGIN_SRC conf :tangle desktop/.local/share/applications/riot.desktop
  [Desktop Entry]
  Name=Riot
...
#+END_SRC
** Saavn
#+BEGIN_SRC conf :tangle desktop/.local/share/applications/saavn.desktop
  [Desktop Entry]
  Name=Saavn
  StartupNotify=true
  Icon=saavn
...
#+END_SRC
** Wire
#+BEGIN_SRC conf :tangle desktop/.local/share/applications/wire.desktop
  [Desktop Entry]
  Name=Wire
...
mature as Emacs.
** Settings
#+BEGIN_SRC json :tangle vscodium/.config/VSCodium/User/settings.json
  {
...
#+END_SRC
** Keybindings
#+BEGIN_SRC json :tangle vscodium/.config/VSCodium/User/keybindings.json
  [
      {
...
and functions.
#+BEGIN_SRC sh :tangle zsh/.config/zsh/setup.sh
  #!/usr/bin/env bash
...
** Template
OH-MY-ZSH template.
#+BEGIN_SRC sh :tangle zsh/.config/zsh/oh-my.zsh
...
** Functions
*** Weather
#+BEGIN_SRC sh :tangle zsh/.config/zsh/func.zsh
  wttr() {
      curl https://wttr.in/${1:-Bhubaneswar}
  }
#+END_SRC
** Variables
#+BEGIN_SRC sh :tangle zsh/.config/zsh/var.zsh
